...
with col1:
    ...
    # ---------------------------------------
    # Side-by-side panel: Summary + Update Log
    # ---------------------------------------
    highlight_col, update_col = st.columns(2)
    ...
    with update_col:
        ...
        <ul>
            ...
            <li><b>2025-04-19</b>: Initial release of SOcat viewer with filtering + plotting.</li>
        </ul>
        """, unsafe_allow_html=True)
